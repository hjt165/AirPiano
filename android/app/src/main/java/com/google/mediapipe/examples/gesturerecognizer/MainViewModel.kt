...
class MainViewModel : ViewModel() {
    ...
    private var _tapThreshold: Float = 0.025f
    private var _holdThreshold: Float = 0.015f
    private var _smoothingFactor: Float = 0.8f

    val currentTapThreshold: Float get() = _tapThreshold
    val currentHoldThreshold: Float get() = _holdThreshold
    val currentSmoothingFactor: Float get() = _smoothingFactor

    fun setTapThreshold(value: Float) { _tapThreshold = value }
    fun setHoldThreshold(value: Float) { _holdThreshold = value }
    fun setSmoothingFactor(value: Float) { _smoothingFactor = value }
}
